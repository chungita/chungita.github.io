...
const translations = {
    ...
    'zh': {
        ...
        'cv_button': '下載我的履歷 (CV)',
        'projects_title': '作品集',
        'project1_title': '專案一：ECG 訊號即時監測',
        'project1_desc': '[簡短描述]：此專案開發了一個 Arduino 程式，能即時接收並視覺化穿戴式裝置傳來的 ECG 訊號，並使用 K-means 演算法初步篩選心律不整波形。',
    ...
    'en': {
        ...
        'project1_title': 'Project 1: Real-time ECG Signal Monitoring',
        'project1_desc': 'This project developed an Arduino program to receive and visualize ECG signals from a wearable device in real-time, and used K-means clustering to preliminarily screen arrhythmic waveforms.',
